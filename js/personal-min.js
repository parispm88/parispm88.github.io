!(function (a) {
        ...
        a(".page__content")
            ...
            .imagesLoaded({ background: !0 }, function () {
                a(".portfolio-wrap").imagesLoaded(function () {
                    a(".portfolio-wrap").masonry({ itemSelector: ".portfolio-item", transitionDuration: 0 });
                }),
                    a(".blog-wrap").imagesLoaded(function () {
                        a(".blog-wrap").masonry({ itemSelector: ".blog-post", transitionDuration: 0 });
                    }),
        ...
        a(".gallery").each(function () {
            ...
            e.append('<div class="gallery__wrap"></div>'),
                ...
                e.find(".gallery__wrap img").each(function () {
                    ...
                    a(this)
                        .wrapAll('<div class="gallery__item"><a href="' + t + '" class="gallery__item__link"></div></div>')
                        .appendTo();
                }),
                e.imagesLoaded(function () {
                    if ("1" === n) {
                        e.addClass("gallery--carousel"),
                            ...
                            e.children(".gallery__wrap").owlCarousel({ items: 1, loop: !0, mouseDrag: !1, touchDrag: !0, pullDrag: !1, dots: !0, autoplay: !1, autoplayTimeout: 6e3, autoHeight: !0, animateOut: "fadeOut" });
                        var a = new Waypoint({
            ...
            a(".single p > img").each(function () {
                ...
                a(this).insertAfter(t), a(this).wrapAll('<div class="image-wrap"></div>'), t.remove();
            }),
            a(".single iframe").each(function () {
                if (a(this).attr("src").indexOf("youtube") >= 0 || a(this).attr("src").indexOf("vimeo") >= 0) {
                    ...
                    a(this).wrapAll('<div class="video-wrap"><div class="video" style="padding-bottom:' + o + '%;"></div></div>');
                }
            }),
    ...
    n.Adapter.bind(window, "statechange", function () {
        ...
        a("body").hasClass("ajax-loading") &&
            a(document).on("click", "a", function (t) {
                ...
                a(this).hasClass("js-no-ajax") || l.indexOf("#") >= 0 || l.indexOf("mailto:") >= 0 || l.indexOf("tel:") >= 0
                    ? (window.location = l)
                    : a(this).is(".gallery__item__link") || (l.indexOf("http") >= 0 ? window.open(l, "_blank") : ((e = l), n.pushState(null, o, l)));
            }),
        t(),
        ...
        a(document).on("click", ".post", function () {
            ...
            a("body").hasClass("ajax-loading") ? ((e = t), n.pushState(null, o, t)) : (window.location = t);
        }),
        a(document).on("click", ".blog-post", function () {
            var t = a(this).find(".blog-post__title a").attr("href");
            a("body").hasClass("ajax-loading") ? ((e = t), n.pushState(null, o, t)) : (window.location = t);
        }),
        a(document).on("submit", "#contact-form", function (t) {
            ...
            "" === e.val() && e.closest(".contact-form__item").addClass("contact-form__item--error"),
                ...
                ("" !== e.val() && "" !== o.val() && "" !== n.val() && 0 === l.val().length) || t.preventDefault();
        });
})(jQuery);